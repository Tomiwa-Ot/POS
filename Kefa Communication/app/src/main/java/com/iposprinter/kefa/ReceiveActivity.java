...
public class ReceiveActivity extends AppCompatActivity {
    ...
    String wallet, fullname;

    private Random random = new Random();

    private static final String TAG = "KEFA Printer";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Receive");
        wallet = getIntent().getStringExtra("address");
...
//此时当前任务会继续打印，完成当前任务后，请等待2分钟以上时间，继续下一个打印任务
                ...
                case PRINTER_CURRENT_TASK_PRINT_COMPLETE_ACTION:
                    ...
                    break;
                case GET_CUST_PRINTAPP_PACKAGENAME_ACTION:
